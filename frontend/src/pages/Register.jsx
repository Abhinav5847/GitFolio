      ...
      <div className="auth-content">
        ...
        <div className="auth-info">
          ...
          <ul className="features-list">
            ...
            <li>
              <svg className="feature-icon" style={{width: '20px', height: '20px', stroke: 'currentColor', fill: 'none', strokeWidth: 2, strokeLinecap: 'round', strokeLinejoin: 'round'}} viewBox="0 0 24 24"><path d="m13 2-2 9h9l-9 11 2-9H4l9-11z"/></svg>
