    ...
    <div className="auth-page">
      <div className="auth-grid">
        ...
        <div className="auth-editorial">
          ...
          <h1>
            Create <br />
            your <span className="italic-serif text-accent">identity</span>.
          </h1>
          <p>
            Establish a digital presence that perfectly represents your technical expertise and design sensibility.
          </p>
        </div>
        ...
        <div className="auth-form-panel">
          ...
          <p className="auth-subtitle">Set up your account</p>
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            <div className="input-group">
              ...
              <input
                ...
                id="username"
                name="username"
                className={`print-input ${errors.username ? 'is-invalid' : ''}`}
            ...
            <div className="input-group">
              ...
              <input
                ...
                className={`print-input ${errors.confirmPassword ? 'is-invalid' : ''}`}
